jQuery(function ($) {
    ...
    $(document).ready(function () {
        ...
        function getEachPopupQtyItem(index = 0){
            ...
            contentHtml += '<option value="0">--</option> <option value="1/8">1/8</option>';
            contentHtml += '<option value="1/4">1/4</option> <option value="3/8">3/8</option>';
            contentHtml += '<option value="1/2">1/2</option> <option value="5/8">5/8</option>';
            contentHtml += ' <option value="3/4">3/4</option> <option value="7/8">7/8</option> </select>';
            contentHtml += "in.";
