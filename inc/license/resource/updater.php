...
if ( ! class_exists( 'Plugin_Updater' ) ) {
	...
	class Plugin_Updater {
		 ...
		 * Class constructor.
		 * 
		 * Extra Data Adding (Added new by Saiful)
		 * such: ['cache_expire_time' => '+6 hours']
		 * By this array, you can input any type of built in property of Plugin_Updater
		 *
		 ...
		 * @param array   $extra_data    Optional data to send with Extra Data.
		 * such: ['cache_expire_time' => '+6 hours']
		 * By this array, you can input any type of built in property of Plugin_Updater
		 * 
		 */
		public function __construct( $_api_url, $_plugin_file, $_api_data = null, $extra_data = [] ) {
			...
			if( ! empty( $extra_data ) && is_array( $extra_data )){
				foreach( $extra_data as $property_name => $property_value ){
